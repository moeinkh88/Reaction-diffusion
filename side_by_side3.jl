...
println("Solving Mismatched Memory System (β = 0.8, 1.0)...")
...
for i in 1:save_interval:num_steps
    ...
    p3 = heatmap(frame_r2; title="Mismatched Memory (β=0.8, 1.0)", hm_args...)
...
println("Done! Files saved as Memory_Comparison_Static3.png/svg and Memory_Comparison_Evolution3.gif")